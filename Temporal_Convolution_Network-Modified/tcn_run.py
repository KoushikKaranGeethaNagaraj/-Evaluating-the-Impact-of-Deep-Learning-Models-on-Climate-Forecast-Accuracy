...
class TCNRun:
    ...
    def load_data(self):
        ...
        if self.args.mode=="train":
            ...
            train_class_1.train(model, train_loader, test_loader, optimizer, criterion, self.device, self.args.epochs,self.args.save_folder_name)
        ...
        if self.args.mode=="inference":
            ...
            prediction_total,total_target_time,total_target_data,res_save_path=train_class_1.evaluate_test(model,data.inference_data,self.device,data.timestamps_data,self.args.save_folder_name,self.args.recursive_limit,self.args.input_train_sequence,self.args.forecast_factor)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_folder_name', type=str, default='classic_mod_128_128_256_256_sq_8_f3')
    ...
    #This is the factor that uses n+k-----k+m approach of sequence where m is the factor(predicting future) , baed on this the predictions /sequences are made and reurive rollout
    ...
    parser.add_argument('--recursive_limit', type=int, default=54)#train percentage
    ...
    parser.add_argument('--features', type=list, default=[0,1,4,12,16,20])#MODEL OUTPUT/INPUT  FEATURES TO PLOT DURING INFERENCE
